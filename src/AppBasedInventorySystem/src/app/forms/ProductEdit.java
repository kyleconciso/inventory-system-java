...
public class ProductEdit extends javax.swing.JFrame {
    ...
    public ProductEdit(Product product) {
        ...
        // Update text fields to match product info
        this.nameTextField.setText(product.getName());
        this.brandTextField.setText(product.getBrand());
        this.quantityTextField.setText(Integer.toString(product.getQuantity()));
        this.descriptionTextField.setText(product.getDescription());
        this.priceTextField.setText(product.getPrice()+"");

    }
    
    public void updateProduct() {
        // Delete old product, create updated product
        inventory.removeBySku(this.product.getSku());
    ...
    public static void main(Product product) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProductEdit app = new ProductEdit(product);
                app.setVisible(true);
